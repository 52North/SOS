 ...
 * 
 */
public class SeriesObservation extends AbstractObservation implements Serializable, HasSeries,
        HasFeatureOfInterestGetter, HasObservablePropertyGetter, HasProcedureGetter {
