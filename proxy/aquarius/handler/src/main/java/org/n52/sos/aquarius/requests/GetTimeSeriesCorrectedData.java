...
public class GetTimeSeriesCorrectedData extends AbstractGetTimeSeriesData {
    ...
    public GetTimeSeriesCorrectedData(String timeSeriesUniqueId) {
        super(timeSeriesUniqueId);
    }
    ...
    public Boolean getReturnFullCoverage() {
        return returnFullCoverage;
    }

    public GetTimeSeriesCorrectedData setReturnFullCoverage(Boolean returnFullCoverage) {
        this.returnFullCoverage = returnFullCoverage ? returnFullCoverage : null;
        return this;
    }
    ...
    public Boolean getIncludeGapMarkers() {
        return includeGapMarkers;
    }

    public GetTimeSeriesCorrectedData setIncludeGapMarkers(Boolean includeGapMarkers) {
        this.includeGapMarkers = includeGapMarkers ? null : includeGapMarkers;
        return this;
    }
