...
##### ResponseEvent
- **sresp-content-type** - HTTP content type of the response
...
- **insertresulttemplate-observation-template** - the observation template contains the procedure, observedProperty, featureOfInterest, observationType fields
...
- **getresult-spatial-filter** - spatial filter of the request
- **getresult-temporal-filter** - temporal filters of the request
