...
{    
     ...
     */
    public EpanetObservableObjectCursor(ObservableModel observableModel, String sqliteFileName, CoordinateReferenceSystem coordinateSystem, String objectFilterPattern, ReferencedEnvelope envelope, java.util.Date dateFrom, java.util.Date dateTo, String whereClause) throws RuntimeException
    {
