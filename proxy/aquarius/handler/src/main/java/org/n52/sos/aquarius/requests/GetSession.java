...
public class GetSession extends AbstractPostRequest<SessionRequestEntity> {
    ...
    public GetSession(SessionRequestEntity content) {
        setContent(content);
    }
     ...
     *            the content to set
     */
    public GetSession setContent(SessionRequestEntity content) {
    ...
    public String getContent() throws JsonProcessingException {
        return hasContent() ? om.writeValueAsString(content) : "";
    }
