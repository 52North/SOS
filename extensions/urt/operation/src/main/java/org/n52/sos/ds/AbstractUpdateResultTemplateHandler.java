 ...
 */
@Configurable
public abstract class AbstractUpdateResultTemplateHandler extends AbstractOperationDAO {
    
    public AbstractUpdateResultTemplateHandler(String service) {
        super(service, UpdateResultTemplateConstants.OPERATION_NAME);
    }
