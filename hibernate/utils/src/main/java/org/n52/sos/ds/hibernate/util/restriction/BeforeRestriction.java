...
public class BeforeRestriction implements TemporalRestriction {
    ...
    public Predicate filterPeriodWithPeriod(CriteriaBuilder cb, Path<Date> selfBegin, Path<Date> selfEnd,
        ...
        return cb.lessThan(selfEnd, otherBegin);
    }
