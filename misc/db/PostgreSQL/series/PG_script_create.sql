...
create table public.address (pkid int8 not null, nilReason varchar(255), href varchar(255), type varchar(255), role varchar(255), arcrole varchar(255), title varchar(255), show varchar(255), actuate varchar(255), remoteSchema varchar(255), id varchar(255), uuid varchar(255), city varchar(255), administrativeArea varchar(255), postalCode varchar(255), country varchar(255), primary key (pkid));
comment on column public.address.pkid is 'Table primary key, used for relations';
create table public.addressdeliveryPoint (addressId int8 not null, deliveryPoint varchar(255) not null, primary key (addressId, deliveryPoint));
create table public.addressemail (addressId int8 not null, electronicMailAddress varchar(255) not null, primary key (addressId, electronicMailAddress));
...
create table public.contact (pkid int8 not null, nilReason varchar(255), href varchar(255), type varchar(255), role varchar(255), arcrole varchar(255), title varchar(255), show varchar(255), actuate varchar(255), remoteSchema varchar(255), id varchar(255), uuid varchar(255), phoneId int8, addressId int8, onlineresourceid int8, hoursOfService varchar(255), contactInstructions varchar(255), primary key (pkid));
comment on column public.contact.pkid is 'Table primary key, used for relations';
create table public.coordinatesystemaxis (pkid int8 not null, nilReason varchar(255), href varchar(255), type varchar(255), role varchar(255), arcrole varchar(255), title varchar(255), show varchar(255), actuate varchar(255), remoteSchema varchar(255), identifier varchar(255), codespace int8, name varchar(255), codespaceName int8, description varchar(255), remarks varchar(255), axisAbbrev varchar(255), codespaceAxisAbbrev int8, axisDirection varchar(255), codespaceAxisDirection int8, minimumValue float8, maximumValue float8, rangeMeaning varchar(255), codespaceRangeMeaning int8, unitId int8 not null, primary key (pkid));
comment on column public.coordinatesystemaxis.pkid is 'Table primary key, used for relations';
comment on column public.coordinatesystemaxis.identifier is 'The identifier of the object, gml:identifier. Used as parameter for queries. Optional but unique';
comment on column public.coordinatesystemaxis.codespace is 'Relation/foreign key to the codespace table. Contains the gml:identifier codespace. Optional';
comment on column public.coordinatesystemaxis.name is 'The name of the object, gml:name. Optional';
comment on column public.coordinatesystemaxis.codespaceName is 'The name of the object, gml:name. Optional';
comment on column public.coordinatesystemaxis.description is 'Description of the object, gml:description. Optional';
...
create table public.domainofvalidity (pkid int8 not null, nilReason varchar(255), href varchar(255), type varchar(255), role varchar(255), arcrole varchar(255), title varchar(255), show varchar(255), actuate varchar(255), remoteSchema varchar(255), identifier varchar(255), codespace int8, name varchar(255), codespaceName int8, description varchar(255), exExtentId int8, primary key (pkid));
comment on column public.domainofvalidity.pkid is 'Table primary key, used for relations';
comment on column public.domainofvalidity.identifier is 'The identifier of the object, gml:identifier. Used as parameter for queries. Optional but unique';
comment on column public.domainofvalidity.codespace is 'Relation/foreign key to the codespace table. Contains the gml:identifier codespace. Optional';
comment on column public.domainofvalidity.name is 'The name of the object, gml:name. Optional';
comment on column public.domainofvalidity.codespaceName is 'The name of the object, gml:name. Optional';
comment on column public.domainofvalidity.description is 'Description of the object, gml:description. Optional';
create table public.exextent (pkid int8 not null, id varchar(255), uuid varchar(255), description varchar(255), primary key (pkid));
comment on column public.exextent.pkid is 'Table primary key, used for relations';
create table public.exextentverticalext (exExtentId int8 not null, exVerticalExtentId int8 not null, primary key (exExtentId, exVerticalExtentId));
...
create table public.onlineresource (pkid int8 not null, nilReason varchar(255), href varchar(255), type varchar(255), role varchar(255), arcrole varchar(255), title varchar(255), show varchar(255), actuate varchar(255), id varchar(255), uuid varchar(255), linkage varchar(255), protocol varchar(255), applicationProfile varchar(255), name varchar(255), description varchar(255), function varchar(255), primary key (pkid));
comment on column public.onlineresource.pkid is 'Table primary key, used for relations';
...
create table public.phonefacsimile (phoneId int8 not null, facsimile varchar(255) not null, primary key (phoneId, facsimile));
create table public.phonevoice (phoneId int8 not null, voice varchar(255) not null, primary key (phoneId, voice));
...
create table public.responsibleparty (pkid int8 not null, nilReason varchar(255), href varchar(255), type varchar(255), role varchar(255), arcrole varchar(255), title varchar(255), show varchar(255), actuate varchar(255), remoteSchema varchar(255), id varchar(255), uuid varchar(255), individualName varchar(255), organizationName varchar(255), positionName varchar(255), contactInfo int8, ciRole int8, primary key (pkid));
comment on column public.responsibleparty.pkid is 'Table primary key, used for relations';
...
create table public.role (pkid int8 not null, codeList varchar(255) not null, codeListValue varchar(255) not null, primary key (pkid));
comment on column public.role.pkid is 'Table primary key, used for relations';
...
create table public.specimen (featureOfInterestId int8 not null, materialClass varchar(255) not null, samplingTimeStart timestamp not null, samplingTimeEnd timestamp not null, samplingMethod varchar(255), size float8, sizeUnitId int8, currentLocation varchar(255), specimenType varchar(255), primary key (featureOfInterestId));
comment on column public.specimen.featureOfInterestId is 'Foreign Key (FK) to the related featureOfInterest from the featureOfInterest table. Contains "featureOfInterest".featureOfInterestId';
comment on column public.specimen.materialClass is 'Material class';
comment on column public.specimen.samplingTimeStart is 'Time stamp when the specimen was started';
comment on column public.specimen.samplingTimeEnd is 'Time stamp when the specimen was stopped';
comment on column public.specimen.samplingMethod is 'Sampling method as referenced link';
comment on column public.specimen.size is 'Sampling method as referenced link';
comment on column public.specimen.sizeUnitId is 'Foreign Key (FK) to the related unit of measure. Contains "unit".unitid. Optional';
comment on column public.specimen.currentLocation is 'Sampling method as referenced link';
comment on column public.specimen.specimenType is 'Specimen type';
...
create table public.telephone (pkid int8 not null, nilReason varchar(255), href varchar(255), type varchar(255), role varchar(255), arcrole varchar(255), title varchar(255), show varchar(255), actuate varchar(255), remoteSchema varchar(255), id varchar(255), uuid varchar(255), primary key (pkid));
comment on column public.telephone.pkid is 'Table primary key, used for relations';
...
create table public.verticalcrs (pkid int8 not null, nilReason varchar(255), href varchar(255), type varchar(255), role varchar(255), arcrole varchar(255), title varchar(255), show varchar(255), actuate varchar(255), remoteSchema varchar(255), identifier varchar(255), codespace int8, name varchar(255), codespaceName int8, description varchar(255), remarks varchar(255), verticalCS int8, verticalDatum int8, primary key (pkid));
comment on column public.verticalcrs.pkid is 'Table primary key, used for relations';
comment on column public.verticalcrs.identifier is 'The identifier of the object, gml:identifier. Used as parameter for queries. Optional but unique';
comment on column public.verticalcrs.codespace is 'Relation/foreign key to the codespace table. Contains the gml:identifier codespace. Optional';
comment on column public.verticalcrs.name is 'The name of the object, gml:name. Optional';
comment on column public.verticalcrs.codespaceName is 'The name of the object, gml:name. Optional';
comment on column public.verticalcrs.description is 'Description of the object, gml:description. Optional';
create table public.verticalcrscope (verticalcrsId int8 not null, scope varchar(255) not null, primary key (verticalcrsId, scope));
create table public.verticalcrsdomofval (verticalcrsId int8 not null, domainOfValidity int8 not null, primary key (verticalcrsId, domainOfValidity));
create table public.verticalcs (pkid int8 not null, nilReason varchar(255), href varchar(255), type varchar(255), role varchar(255), arcrole varchar(255), title varchar(255), show varchar(255), actuate varchar(255), remoteSchema varchar(255), identifier varchar(255), codespace int8, name varchar(255), codespaceName int8, description varchar(255), remarks varchar(255), aggregation varchar(255), primary key (pkid));
comment on column public.verticalcs.pkid is 'Table primary key, used for relations';
comment on column public.verticalcs.identifier is 'The identifier of the object, gml:identifier. Used as parameter for queries. Optional but unique';
comment on column public.verticalcs.codespace is 'Relation/foreign key to the codespace table. Contains the gml:identifier codespace. Optional';
comment on column public.verticalcs.name is 'The name of the object, gml:name. Optional';
comment on column public.verticalcs.codespaceName is 'The name of the object, gml:name. Optional';
comment on column public.verticalcs.description is 'Description of the object, gml:description. Optional';
create table public.verticalcscoodsysaxis (verticalCSId int8 not null, coordinateSystemAxis int8 not null, primary key (verticalCSId, coordinateSystemAxis));
create table public.verticaldatum (pkid int8 not null, nilReason varchar(255), href varchar(255), type varchar(255), role varchar(255), arcrole varchar(255), title varchar(255), show varchar(255), actuate varchar(255), remoteSchema varchar(255), identifier varchar(255), codespace int8, name varchar(255), codespaceName int8, description varchar(255), remarks varchar(255), domainOfValidityId int8, anchorDefinition varchar(255), codespaceAnchorDef int8, realizationEpoch timestamp default NULL, primary key (pkid));
comment on column public.verticaldatum.pkid is 'Table primary key, used for relations';
comment on column public.verticaldatum.identifier is 'The identifier of the object, gml:identifier. Used as parameter for queries. Optional but unique';
comment on column public.verticaldatum.codespace is 'Relation/foreign key to the codespace table. Contains the gml:identifier codespace. Optional';
comment on column public.verticaldatum.name is 'The name of the object, gml:name. Optional';
comment on column public.verticaldatum.codespaceName is 'The name of the object, gml:name. Optional';
comment on column public.verticaldatum.description is 'Description of the object, gml:description. Optional';
create table public.verticaldatumscope (verticalDatumId int8 not null, scope varchar(255) not null, primary key (verticalDatumId, scope));
create table public.verticalexextent (pkid int8 not null, nilReason varchar(255), href varchar(255), type varchar(255), role varchar(255), arcrole varchar(255), title varchar(255), show varchar(255), actuate varchar(255), remoteSchema varchar(255), id varchar(255), uuid varchar(255), minimumValue float8, maximumValue float8, verticalCRSId int8, primary key (pkid));
comment on column public.verticalexextent.pkid is 'Table primary key, used for relations';
create table public.wmlmonitoringpoint (featureOfInterestId int8 not null, primary key (featureOfInterestId));
comment on column public.wmlmonitoringpoint.featureOfInterestId is 'Foreign Key (FK) to the related featureOfInterest from the featureOfInterest table. Contains "featureOfInterest".featureOfInterestId';
create table public.wmlmprelatedparty (featureOfInterestId int8 not null, responsiblePartyId int8 not null, primary key (featureOfInterestId, responsiblePartyId));
create table public.wmlmpverticaldatum (featureOfInterestId int8 not null, verticalDatumId int8 not null, primary key (featureOfInterestId, verticalDatumId));
...
alter table public.coordinatesystemaxis add constraint csaIdentifierUK unique (identifier);
...
alter table public.domainofvalidity add constraint dovIdentifierUK unique (identifier);
...
alter table public.verticalcrs add constraint vcrsIdentifierUK unique (identifier);
alter table public.verticalcs add constraint vcsIdentifierUK unique (identifier);
alter table public.verticaldatum add constraint vdIdentifierUK unique (identifier);
create index vddovIdx on public.verticaldatum (domainOfValidityId);
create index vevcrsIdx on public.verticalexextent (verticalCRSId);
...
alter table public.addressdeliveryPoint add constraint adddelpoiFk foreign key (addressId) references public.address;
alter table public.addressemail add constraint addemailFk foreign key (addressId) references public.address;
...
alter table public.contact add constraint contactphoneFk foreign key (phoneId) references public.telephone;
alter table public.contact add constraint contactaddressFk foreign key (addressId) references public.address;
alter table public.contact add constraint contactonlineresFk foreign key (onlineresourceid) references public.onlineresource;
alter table public.coordinatesystemaxis add constraint csaCodespaceIdentifierFk foreign key (codespace) references public.codespace;
alter table public.coordinatesystemaxis add constraint csaCodespaceNameFk foreign key (codespaceName) references public.codespace;
alter table public.coordinatesystemaxis add constraint scsacodeaaFk foreign key (codespaceAxisAbbrev) references public.codespace;
alter table public.coordinatesystemaxis add constraint scsacodeadFk foreign key (codespaceAxisDirection) references public.codespace;
alter table public.coordinatesystemaxis add constraint scsacodermFk foreign key (codespaceRangeMeaning) references public.codespace;
alter table public.coordinatesystemaxis add constraint csaUnitFk foreign key (unitId) references public.unit;
...
alter table public.domainofvalidity add constraint codCodespaceIdentifierFk foreign key (codespace) references public.codespace;
alter table public.domainofvalidity add constraint codCodespaceNameFk foreign key (codespaceName) references public.codespace;
alter table public.domainofvalidity add constraint dovexeFk foreign key (exExtentId) references public.exextent;
alter table public.exextentverticalext add constraint FK_qppk0ymn6peh5v1571aajqa8g foreign key (exVerticalExtentId) references public.verticalexextent;
alter table public.exextentverticalext add constraint exeexveFk foreign key (exExtentId) references public.exextent;
...
alter table public.phonefacsimile add constraint phonefacsimilefk foreign key (phoneId) references public.telephone;
alter table public.phonevoice add constraint phonevoicefk foreign key (phoneId) references public.telephone;
...
alter table public.responsibleparty add constraint rpcontactFk foreign key (contactInfo) references public.contact;
alter table public.responsibleparty add constraint rproleFk foreign key (ciRole) references public.role;
...
alter table public.specimen add constraint specimenFeatureFk foreign key (featureOfInterestId) references public.featureofinterest;
alter table public.specimen add constraint observationUnitFk foreign key (sizeUnitId) references public.unit;
...
alter table public.verticalcrs add constraint vcrsCodespaceIdentifierFk foreign key (codespace) references public.codespace;
alter table public.verticalcrs add constraint vcrsCodespaceNameFk foreign key (codespaceName) references public.codespace;
alter table public.verticalcrs add constraint vcrsvcsfk foreign key (verticalCS) references public.verticalcs;
alter table public.verticalcrs add constraint vcrsvdfk foreign key (verticalDatum) references public.verticaldatum;
alter table public.verticalcrscope add constraint vcrsscopefk foreign key (verticalcrsId) references public.verticalcrs;
alter table public.verticalcrsdomofval add constraint vcrsdovfk foreign key (domainOfValidity) references public.domainofvalidity;
alter table public.verticalcrsdomofval add constraint vcrsdovidfk foreign key (verticalcrsId) references public.verticalcrs;
alter table public.verticalcs add constraint vcsCodespaceIdentifierFk foreign key (codespace) references public.codespace;
alter table public.verticalcs add constraint vcsCodespaceNameFk foreign key (codespaceName) references public.codespace;
alter table public.verticalcscoodsysaxis add constraint vcscsafk foreign key (coordinateSystemAxis) references public.coordinatesystemaxis;
alter table public.verticalcscoodsysaxis add constraint vcscsaidfk foreign key (verticalCSId) references public.verticalcs;
alter table public.verticaldatum add constraint vdCodespaceIdentifierFk foreign key (codespace) references public.codespace;
alter table public.verticaldatum add constraint vdCodespaceNameFk foreign key (codespaceName) references public.codespace;
alter table public.verticaldatum add constraint vddovFk foreign key (domainOfValidityId) references public.domainofvalidity;
alter table public.verticaldatum add constraint vdCodespaceADefFk foreign key (codespaceAnchorDef) references public.codespace;
alter table public.verticaldatumscope add constraint vdscopefk foreign key (verticalDatumId) references public.verticaldatum;
alter table public.verticalexextent add constraint vevcrsFk foreign key (verticalCRSId) references public.verticalcrs;
alter table public.wmlmonitoringpoint add constraint wmlmpFeatureFk foreign key (featureOfInterestId) references public.featureofinterest;
alter table public.wmlmprelatedparty add constraint wmlmprpFk foreign key (responsiblePartyId) references public.responsibleparty;
alter table public.wmlmprelatedparty add constraint FK_nyt2o5m81p35lqk7rctyook4o foreign key (featureOfInterestId) references public.featureofinterest;
alter table public.wmlmpverticaldatum add constraint FK_r4s9vt1g0o5o4lfi37qrh2yad foreign key (verticalDatumId) references public.verticaldatum;
alter table public.wmlmpverticaldatum add constraint wmlmpvdFk foreign key (featureOfInterestId) references public.featureofinterest;
...
create sequence public.addressId_seq;
create sequence public.codespaceId_seq;
create sequence public.contactId_seq;
create sequence public.coordSysAxisId_seq;
create sequence public.domOfValidityId_seq;
create sequence public.exExtentId_seq;
...
create sequence public.onlineResourceId_seq;
...
create sequence public.responsiblePartyId_seq;
create sequence public.resultTemplateId_seq;
create sequence public.roleId_seq;
create sequence public.seriesId_seq;
create sequence public.seriesRelationId_seq;
create sequence public.telephoneId_seq;
create sequence public.unitId_seq;
create sequence public.validProcedureTimeId_seq;
create sequence public.verticalCRSId_seq;
create sequence public.verticalCSId_seq;
create sequence public.verticalDatumId_seq;
create sequence public.verticalExExtentId_seq;