 ...
 *
 */
public class TimeSeriesProfileSensorDataset extends AbstractStringSensorDataset implements StaticLocationDataset {
    private Double lng;
    private Double lat;
    
    public TimeSeriesProfileSensorDataset( String sensor, Double lng, Double lat, 
