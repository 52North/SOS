...
public class AqdGetCapabilitiesOperatorV10
		extends
		AbstractAqdRequestOperator<AbstractGetCapabilitiesDAO, GetCapabilitiesRequest, GetCapabilitiesResponse> {
	
	private static final String OPERATION_NAME = SosConstants.Operations.GetCapabilities
			.name();
	...
	@Override
	public GetCapabilitiesResponse receive(GetCapabilitiesRequest request)
    ...
    private GetCapabilitiesResponse modifyCapabilities(
