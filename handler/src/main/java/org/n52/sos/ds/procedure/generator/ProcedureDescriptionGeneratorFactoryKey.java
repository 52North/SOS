...
/**
 * Key class for {@link ProcedureDescriptionGeneratorFactory}
 *
 * @author <a href="mailto:c.hollmann@52north.org">Carsten Hollmann</a>
 * @since 4.2.0
 *
 */
public class ProcedureDescriptionGeneratorFactoryKey implements
        Comparable<ProcedureDescriptionGeneratorFactoryKey> {

    private final String procedureDescriptionFormat;

    public ProcedureDescriptionGeneratorFactoryKey(String procedureDescriptionFormat) {
    ...
    @Override
    public int compareTo(ProcedureDescriptionGeneratorFactoryKey o) {
        if (o instanceof ProcedureDescriptionGeneratorFactoryKey) {
    ...
    public boolean equals(Object paramObject) {
        if (paramObject instanceof ProcedureDescriptionGeneratorFactoryKey) {
            ProcedureDescriptionGeneratorFactoryKey toCheck =
                    (ProcedureDescriptionGeneratorFactoryKey) paramObject;
