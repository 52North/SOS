...
public class ServiceEndpointResponse implements RestResponse {
    ...
    public ServiceEndpointResponse(String defaultLandingPointResource) {
        this.defaultLandingPointResource = defaultLandingPointResource;
    }

    public String getDefaultLandingPointResource()
    {
        return defaultLandingPointResource;
    }
