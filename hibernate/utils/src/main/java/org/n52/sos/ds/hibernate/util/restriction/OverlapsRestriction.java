 ...
 * </table>
 */
public class OverlapsRestriction implements TemporalRestriction {
    @Override
    public Predicate filterPeriodWithPeriod(CriteriaBuilder cb, Path<Date> selfBegin, Path<Date> selfEnd,
        ...
        return cb.and(cb.lessThan(selfBegin, otherBegin), cb.greaterThan(selfEnd, otherBegin),
                cb.lessThan(selfEnd, otherEnd));
    }
}