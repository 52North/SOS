 ...
 */
package org.n52.svalbard.inspire.ompr.v30.coding;
...
public class AbtractProcessCodingTest {
    ...
    protected Process createProcessFromFile() throws XmlException, IOException, OwsExceptionReport {
        XmlObject xmlObject = XmlObject.Factory.parse(this.getClass().getResourceAsStream(file));
        Object decodeObject = CodingHelper.decodeXmlObject(xmlObject);
