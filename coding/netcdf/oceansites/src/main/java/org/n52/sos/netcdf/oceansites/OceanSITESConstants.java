...
public interface OceanSITESConstants {
    ...
    public static MediaType CONTENT_TYPE_NETCDF_OCEANSITES = new MediaType("application", "netcdf", "profile", OCEANSITES);
    
    public static MediaType CONTENT_TYPE_NETCDF_3_OCEANSITES = new MediaType("application", "netcdf", ImmutableListMultimap.of("version", "3", "profile", OCEANSITES));
    
    public static MediaType CONTENT_TYPE_NETCDF_4_OCEANSITES = new MediaType("application", "netcdf", ImmutableListMultimap.of("version", "4", "profile", OCEANSITES));
    
    public static MediaType CONTENT_TYPE_NETCDF_ZIP_OCEANSITES = new MediaType("application", "zip", ImmutableListMultimap.of("subtype", "netcdf", "profile", OCEANSITES));
    
    public static MediaType CONTENT_TYPE_NETCDF_3_ZIP_OCEANSITES = new MediaType("application", "zip", ImmutableListMultimap.of("subtype", "netcdf", "version", "3", "profile", OCEANSITES));
    
    public static MediaType CONTENT_TYPE_NETCDF_4_ZIP_OCEANSITES = new MediaType("application", "zip", ImmutableListMultimap.of("subtype", "netcdf", "version", "4", "profile", OCEANSITES));
     ...
     * OPTIONAL</br>
     * 
     * example:  wmo_platform_code=”48409” (OceanSITES specific)</br> 
     * note: WMO (World Meteorological Organization) identifier. This platform number is unique within the OceanSITES project.
     */
     ...
     * OPTIONAL</br>
     * 
     * example: principal_investigator=”Alice Juarez”</br> 
     * note: Name of the person responsible for the project that produced the data contained in the file.
     */
     ...
     * OPTIONAL</br>
     * 
     * example: principal_investigator_email =”AJuarez AT whoi.edu”</br> 
     * note: Email address of the project lead for the project that produced the data contained in the file.
     */
    ...
    /**
     * Default text for license</br>
     * note: A statement describing the data
     ...
     * OPTIONAL</br>
     * 
     * example: processing_level =” Data verified against model or other contextual information” (OceanSITES specific)</br> 
     * note: Level of processing and quality control applied to data. Preferred values are listed in {@link ProcessingLevel}
     */
     ...
     * OPTIONAL</br>
     * 
     * example: QC_indicator =”excellent” (OceanSITES specific)</br>
     * note: A value valid for the whole dataset, one of {@link QCIndicator}
     */
     ...
     * the radio.</br> 
     * 
     * P - Provisional data. Data obtained after instruments
     * have been recovered or serviced; some calibrations or editing may have
     * been done, but the data is not thought to be fully processed. Refer to
     * the history attribute for more detailed information.</br> 
     * 
     * D -
     * Delayed-mode data. Data published after all calibrations and quality
     ...
     * data.</br> 
     * 
     * M - Mixed. This value is only allowed in the global attribute
     * “data_mode” or in attributes to variables in the form
     * “<PARAM>:DM_indicator”. It indicates that the file contains data in more
     * than one of the above states. In this case, the variable(s) <PARAM>_DM
     * specify which data is in which data mode.</br>
     * 
     * @author <a href="mailto:c.hollmann@52north.org">Carsten Hollmann</a>
     * @since 4.4.0
     *
