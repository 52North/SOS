...
public class SosDataMapping {
    ...
    public static final AbstractEsParameter GC_VERSIONS_FIELD = new SingleEsParameter("getcapabilities-versions",
            new Description(InformationOrigin.RequestEvent, Operation.GetCapabilities, "Accept versions"), ElasticsearchTypeRegistry.stringField);

    public static final AbstractEsParameter GC_FORMATS_FIELD = new SingleEsParameter("getcapabilities-formats",
            new Description(InformationOrigin.RequestEvent, Operation.GetCapabilities, "Accept formats"), ElasticsearchTypeRegistry.stringField);

    public static final AbstractEsParameter GC_SECTIONS = new SingleEsParameter("getcapabilities-sections",
            new Description(InformationOrigin.RequestEvent, Operation.GetCapabilities, "Sections"), ElasticsearchTypeRegistry.stringField);

    public static final AbstractEsParameter GC_UPDATE_SEQUENCE = new SingleEsParameter("getcapabilities-updatesequence",
            new Description(InformationOrigin.RequestEvent, Operation.GetCapabilities, "Update sequence"), ElasticsearchTypeRegistry.stringField);
    ...
    public static final AbstractEsParameter GO_FEATURE_OF_INTERESTS = new SingleEsParameter("getobservation-feature-of-interests",
            new Description(InformationOrigin.RequestEvent, Operation.GetObservation, "Feature of interests"), ElasticsearchTypeRegistry.stringField);
    ...
    public static final AbstractEsParameter GO_OBSERVED_PROPERTIES = new SingleEsParameter("getobservation-observed-properties",
            new Description(InformationOrigin.RequestEvent, Operation.GetObservation, "Observed properties"), ElasticsearchTypeRegistry.stringField);

    public static final AbstractEsParameter GO_OFFERINGS = new SingleEsParameter("getobservation-offerings",
            new Description(InformationOrigin.RequestEvent, Operation.GetObservation, "Offerings"), ElasticsearchTypeRegistry.stringField);

    public static final AbstractEsParameter GO_RESPONSE_FORMAT = new SingleEsParameter("getobservation-response-format",
            new Description(InformationOrigin.RequestEvent, Operation.GetObservation, "Response format"), ElasticsearchTypeRegistry.stringField);
    ...
    public static final AbstractEsParameter GFOI_PROCEDURES = new SingleEsParameter("getfeatureofinterest-procedures",
            new Description(InformationOrigin.RequestEvent, Operation.GetFeatureOfInterest, "Procedures"), ElasticsearchTypeRegistry.stringField);
    ...
    public static final AbstractEsParameter IS_ASSIGNED_OFFERINGS = new SingleEsParameter("insertsensor-assigned-offerings",
            new Description(InformationOrigin.RequestEvent, Operation.InsertSensor, "Assigned offerings"), ElasticsearchTypeRegistry.stringField);
    ...
    public static final AbstractEsParameter IS_OBSERVABLE_PROPERTY = new SingleEsParameter("insertsensor-observable-property",
            new Description(InformationOrigin.RequestEvent, Operation.InsertSensor, "Observable properties"), ElasticsearchTypeRegistry.stringField);
    ...
    public static final AbstractEsParameter IS_OBSERVATION_TYPES = new SingleEsParameter("insertsensor-observation-types",
            new Description(InformationOrigin.RequestEvent, Operation.InsertSensor, "Observation types"), ElasticsearchTypeRegistry.stringField);

    // --------------- UPDATE SENSOR --------------//
    public static final AbstractEsParameter US_PROCEDURE_IDENTIFIER = new SingleEsParameter("updatesensor-procedure-identifier",
            new Description(InformationOrigin.RequestEvent, Operation.UpdateSensor, "Procedure ID"), ElasticsearchTypeRegistry.stringField);
    ...
    public static final AbstractEsParameter DELS_PROCEDURE_IDENTIFIER = new SingleEsParameter("deletesensor-procedure-identifier",
            new Description(InformationOrigin.RequestEvent, Operation.DeleteSensor, "Procedure ID"), ElasticsearchTypeRegistry.stringField);
    ...
    public static final AbstractEsParameter IO_OFFERINGS = new SingleEsParameter("insertobservation-offerings",
            new Description(InformationOrigin.RequestEvent, Operation.InsertObservation, "Offering"), ElasticsearchTypeRegistry.stringField);
    ...
    public static final AbstractEsParameter IRT_IDENTIFIER = new SingleEsParameter("insertresulttemplate-identifier",
            new Description(InformationOrigin.RequestEvent, Operation.InsertResultTemplate, "ID"), ElasticsearchTypeRegistry.stringField);
    ...
    public static final AbstractEsParameter IR_TEMPLATE_IDENTIFIER = new SingleEsParameter("insertresult-template-identifier",
            new Description(InformationOrigin.RequestEvent, Operation.InsertResult, "Template ID"), ElasticsearchTypeRegistry.stringField);

    public static final AbstractEsParameter IR_RESULT_VALUES = new SingleEsParameter("insertresult-result-values",
            new Description(InformationOrigin.RequestEvent, Operation.InsertResult, "Result values"), ElasticsearchTypeRegistry.stringField);

    // --------------- GET RESULT TEMPLATE --------------//
    public static final AbstractEsParameter GRT_OBSERVED_PROPERTY = new SingleEsParameter("getresulttemplate-observed-property",
            new Description(InformationOrigin.RequestEvent, Operation.GetResultTemplate, "Observed property"), ElasticsearchTypeRegistry.stringField);

    public static final AbstractEsParameter GRT_OFFERING = new SingleEsParameter("getresulttemplate-offering",
            new Description(InformationOrigin.RequestEvent, Operation.GetResultTemplate, "Offering"), ElasticsearchTypeRegistry.stringField);

    // --------------- GET RESULT --------------//
    public static final AbstractEsParameter GR_FEATURE_IDENTIFIERS = new SingleEsParameter("getresult-feature-identifiers",
            new Description(InformationOrigin.RequestEvent, Operation.GetResult, "Feature IDs"), ElasticsearchTypeRegistry.stringField);
    ...
    public static final AbstractEsParameter GR_OBSERVATION_PROPERTY = new SingleEsParameter("getresult-observation-property",
            new Description(InformationOrigin.RequestEvent, Operation.GetResult, "Observation property"), ElasticsearchTypeRegistry.stringField);

    public static final AbstractEsParameter GR_OFFERING = new SingleEsParameter("getresult-offering",
            new Description(InformationOrigin.RequestEvent, Operation.GetResult, "Offering"), ElasticsearchTypeRegistry.stringField);
    ...
    public static final AbstractEsParameter GDA_OFFERINGS = new SingleEsParameter("getdataavailability-offerings",
            new Description(InformationOrigin.RequestEvent, Operation.GetDataAvailability, "Offering"), ElasticsearchTypeRegistry.stringField);

    public static final AbstractEsParameter GDA_PROCEDURES = new SingleEsParameter("getdataavailability-procedures",
            new Description(InformationOrigin.RequestEvent, Operation.GetDataAvailability, "Procedure"), ElasticsearchTypeRegistry.stringField);
}
