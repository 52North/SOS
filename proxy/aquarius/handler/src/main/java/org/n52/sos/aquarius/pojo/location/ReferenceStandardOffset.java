...
public class ReferenceStandardOffset implements Serializable {
    ...
    public ReferenceStandardOffset(String standard, Integer offsetToReferenceStandard) {
        super();
        this.standard = standard;
        this.offsetToReferenceStandard = offsetToReferenceStandard;
    }
    ...
    public Integer getOffsetToReferenceStandard() {
        return offsetToReferenceStandard;
    }

    @JsonProperty("OffsetToReferenceStandard")
    public void setOffsetToReferenceStandard(Integer offsetToReferenceStandard) {
        this.offsetToReferenceStandard = offsetToReferenceStandard;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this).append("standard", standard)
                .append("offsetToReferenceStandard", offsetToReferenceStandard)
    ...
    public int hashCode() {
        return new HashCodeBuilder().append(standard)
                .append(offsetToReferenceStandard)
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ReferenceStandardOffset)) {
            return false;
        }
        ReferenceStandardOffset rhs = (ReferenceStandardOffset) other;
        return new EqualsBuilder().append(standard, rhs.standard)
                .append(offsetToReferenceStandard, rhs.offsetToReferenceStandard)
