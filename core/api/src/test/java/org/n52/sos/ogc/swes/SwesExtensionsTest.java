...
public class SwesExtensionsTest {
    ...
    public void isEmpty_should_return_false_if_at_least_one_extension_is_set() {
        ...
        extensions.addExtension(new SwesExtension<Boolean>().setDefinition(DEFINITION_1));
    ...
    public void isBooleanExtensionSet_should_return_true_if_set_to_true() {
        final Extensions extensions = new Extensions();
        extensions.addExtension(new SwesExtension<SweBoolean>().setDefinition(DEFINITION_1).setValue(new SweBoolean().setValue(TRUE)));
   ...
   public void containsExtension_for_string_schould_return_true() {
       final Extensions extensions = new Extensions();
       extensions.addExtension(new SwesExtension<String>().setDefinition(DEFINITION_1).setValue(new String()));
       extensions.addExtension(new SwesExtension<String>().setDefinition(DEFINITION_2).setValue(new String()));
       extensions.addExtension(new SwesExtension<String>().setDefinition(DEFINITION_3).setValue(new String()));
   ...
   public void getExtension_for_string_schould_return_true() {
       final Extensions extensions = new Extensions();
       extensions.addExtension(new SwesExtension<String>().setDefinition(DEFINITION_1).setValue(VALUE_1));
       extensions.addExtension(new SwesExtension<Integer>().setDefinition(DEFINITION_2).setValue(VALUE_2));
       extensions.addExtension(new SwesExtension<Boolean>().setDefinition(DEFINITION_3).setValue(VALUE_3));
