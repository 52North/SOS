...
public class ObservableContextArgs {
     ...
     */
    public ObservableContextArgs(String objectId, SpatialFilter spatialFilter, ReferencedEnvelope envelope, TemporalFilter temporalFilter, Date dateFrom, Date dateTo, int requestFlags)
    {
