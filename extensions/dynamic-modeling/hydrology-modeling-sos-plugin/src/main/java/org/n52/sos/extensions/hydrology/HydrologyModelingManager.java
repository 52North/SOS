...
public class HydrologyModelingManager implements VirtualCapabilitiesExtension 
{
    ...
    public static String DEFAULT_SETTINGS_FILE = "../hydrology-core-library/misc/dynamic-models/hydrology-settings.xml";
    ...
    private static class LazyHolder {
        private static final HydrologyModelingManager INSTANCE = new HydrologyModelingManager(DEFAULT_SETTINGS_FILE);
