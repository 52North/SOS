...
public class SQLiteSettingsManagerTest {
    ...
    private static final ProcedureDescriptionFormatKey PDFKT =
            new ProcedureDescriptionFormatKey(SOKT, PROCEDURE_DESCRIPTION_FORMAT);
    ...
    // final BooleanSettingDefinition settingDefinition = new
    // BooleanSettingDefinition().setKey(BOOLEAN_SETTING);
    // final SettingValue<Boolean> settingValue = new
    // BooleanSettingValue().setKey(BOOLEAN_SETTING).setValue(
    // Boolean.TRUE);
    // final SettingValue<Boolean> newSettingValue = new
    // BooleanSettingValue().setKey(BOOLEAN_SETTING)
    ...
    // ConnectionProviderException {
    // final StringSettingDefinition settingDefinition = new
    // StringSettingDefinition().setKey(STRING_SETTING);
    // final SettingValue<String> settingValue = new
    // StringSettingValue().setKey(STRING_SETTING).setValue("string1");
    // final SettingValue<String> newSettingValue = new
    // StringSettingValue().setKey(STRING_SETTING)
    // .setValue("string2");
    // testSaveGetAndDelete(settingDefinition, settingValue, newSettingValue);
    // }
    //
    ...
    // ConnectionProviderException {
    // final FileSettingDefinition settingDefinition = new
    // FileSettingDefinition().setKey(FILE_SETTING);
    // final SettingValue<File> settingValue = new
    // FileSettingValue().setKey(FILE_SETTING).setValue(new File(
    // "/home/auti/sos1"));
    // final SettingValue<File> newSettingValue = new
    // FileSettingValue().setKey(FILE_SETTING).setValue(new File(
    // "/home/auti/sos2"));
    // testSaveGetAndDelete(settingDefinition, settingValue, newSettingValue);
    // }
    ...
    // ConnectionProviderException {
    // final IntegerSettingDefinition settingDefinition = new
    // IntegerSettingDefinition().setKey(INTEGER_SETTING);
    // final SettingValue<Integer> settingValue = new
    // IntegerSettingValue().setKey(INTEGER_SETTING).setValue(12312);
    // final SettingValue<Integer> newSettingValue = new
    // IntegerSettingValue().setKey(INTEGER_SETTING).setValue(12311);
    // testSaveGetAndDelete(settingDefinition, settingValue, newSettingValue);
    // }
    //
    // @Test
    ...
    // ConnectionProviderException {
    // final NumericSettingDefinition settingDefinition = new
    // NumericSettingDefinition().setKey(DOUBLE_SETTING);
    // final SettingValue<Double> settingValue = new
    // NumericSettingValue().setKey(DOUBLE_SETTING).setValue(212.1213);
    // final SettingValue<Double> newSettingValue = new
    // NumericSettingValue().setKey(DOUBLE_SETTING)
    // .setValue(212.1211);
    // testSaveGetAndDelete(settingDefinition, settingValue, newSettingValue);
    // }
    //
    ...
    // ConnectionProviderException {
    // final UriSettingDefinition settingDefinition = new
    // UriSettingDefinition().setKey(URI_SETTING);
    // final SettingValue<URI> settingValue = new
    // UriSettingValue().setKey(URI_SETTING).setValue(URI.create(
    // "http://localhost:8080/a"));
    // final SettingValue<URI> newSettingValue = new
    // UriSettingValue().setKey(URI_SETTING).setValue(URI.create(
    ...
    // public void testChangedSettingsTypeForKey() throws
    // ConfigurationException, ConnectionProviderException {
    // final SettingValue<Double> doubleValue = new
    // NumericSettingValue().setKey(BOOLEAN_SETTING).setValue(212.1213);
    // settingsManager.changeSetting(doubleValue);
    // }
    //
    // public <T> void testSaveGetAndDelete(final SettingDefinition<? extends
    // SettingDefinition<?, T>, T> settingDefinition,
    // final SettingValue<T> settingValue, final SettingValue<T>
    // newSettingValue)
    ...
    // assertEquals(settingValue,
    // settingsManager.getSetting(settingDefinition));
    //
    // settingsManager.changeSetting(newSettingValue);
    // final SettingValue<T> value =
    // settingsManager.getSetting(settingDefinition);
    ...
    // AdministratorUser au = settingsManager.createAdminUser(USERNAME,
    // PASSWORD);
    // assertNotNull(au);
    ...
    //
    // @Test
    // public void testActiveResponseFormats() throws
    // ConnectionProviderException {
    ...
    //
    // @Test
    // public void testActiveProcedureDescriptionFormats() throws
    // ConnectionProviderException {
    // assertThat(settingsManager.isProcedureDescriptionFormatActive(PDFKT),
    // is(true));
    ...
    // assertThat(settingsManager.isActive(PROCEDURE_DESCRIPTION_FORMAT),
    // is(true));
    // settingsManager.setActive(PROCEDURE_DESCRIPTION_FORMAT, true);
    // assertThat(settingsManager.isActive(PROCEDURE_DESCRIPTION_FORMAT),
    // is(true));
    // settingsManager.setActive(PROCEDURE_DESCRIPTION_FORMAT, false);
    // assertThat(settingsManager.isActive(PROCEDUColumnRE_DESCRIPTION_FORMAT),
    // is(false));

    // }
    //
    // @Test
    // public void testLocalizedStringSetting() throws ConfigurationException,
    // ConnectionProviderException {
    // final MultilingualStringSettingDefinition settingDefinition = new
    // MultilingualStringSettingDefinition().setKey(LOCALIZED_STRING_SETTING);
    // MultilingualString l1 = new
    // MultilingualString().addLocalization(Locale.GERMAN,
    // "Hallo").addLocalization(Locale.ENGLISH, "Hello");
    // MultilingualString l2 = new
    // MultilingualString().addLocalization(Locale.GERMAN,
    // "Hallo").addLocalization(Locale.ENGLISH,
    // "Hello").addLocalization(Locale.CHINESE, "???");
    // SettingValue<MultilingualString> settingValue = new
    // MultilingualStringSettingValue().setKey(LOCALIZED_STRING_SETTING).setValue(l1);
    // SettingValue<MultilingualString> newSettingValue = new
    // MultilingualStringSettingValue().setKey(LOCALIZED_STRING_SETTING).setValue(l2);
    // testSaveGetAndDelete(settingDefinition, settingValue, newSettingValue);
    // }
    //
    //
    // @Test
    // public void testChoiceSettings() throws ConfigurationException,
    // ConnectionProviderException {
    // final ChoiceSettingDefinition settingDefinition = new
    // ChoiceSettingDefinition().setKey(CHOICE_SETTING);
    // final SettingValue<String> settingValue = new
    // ChoiceSettingValue().setKey(CHOICE_SETTING).setValue("string1");
    // final SettingValue<String> newSettingValue = new
    // ChoiceSettingValue().setKey(CHOICE_SETTING)
    // .setValue("string2");
    // testSaveGetAndDelete(settingDefinition, settingValue, newSettingValue);
    // }
}
