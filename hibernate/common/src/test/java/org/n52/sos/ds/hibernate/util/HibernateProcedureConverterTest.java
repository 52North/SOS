...
public class HibernateProcedureConverterTest implements SensorMLConstants, OGCConstants {
    ...
    // private static HibernateProcedureDescriptionGeneratorFactoryRepository
    // FACTORY_REPOSITORY;
    ...
    //
    // PROCEDURE_DESCRIPTION_NON_SPATIAL = format("The %s with the id %s
    // observes the following properties: %s.",
    // "procedure", PROCEDURE_IDENTIFIER,
    // Joiner.on(",").join(OBSERVABLE_PROPERTIES));
    //
    // METHOD_DESCRIPTION = format(
    // "The procedure %s generates the following output(s): %s. The input(s)
    // is/are unknown (this description is generated).",
    ...
    // hibernateProcedureDescriptionGeneratorSml101 =
    // new HibernateProcedureDescriptionGeneratorFactorySml101(daoFactory,
    // settingsService, geometryHandler, i18NDAORepository, cacheController,
    // profileHandler);
    // FACTORY_REPOSITORY =
    // new HibernateProcedureDescriptionGeneratorFactoryRepository();
    // FACTORY_REPOSITORY.
    //
    // new SensorML20SensorML101Converter();
    // CONVERTER_REPOSITORY = new ConverterRepository();
    // CONVERTER_REPOSITORY.setComponents(Optional
    // .of(Lists.newArrayList(new SensorML20SensorML101Converter(), new
    ...
    // mock(ConverterRepository.class);
    ...
    // mock(ServiceOperatorRepository.class);
    // ContentCacheController contentCacheController =
    // mock(ContentCacheController.class);
    // ProcedureDescriptionSettings procedureSettings =
    // mock(ProcedureDescriptionSettings.class);
    //
    // HibernateProcedureCreationContext ctxMock =
    // mock(HibernateProcedureCreationContext.class);
    //
    //// new HibernateProcedureCreationContext(SERVICE_METADATA_REPO,
    //// decoderRepository, FACTORY_REPOSITORY, i18nr, daoFactory,
    // converterRepository, geometryHandler,
    //// bindingRepository, serviceOperatorRepository, contentCacheController,
    // procedureSettings);
    ...
    ////
    //// when(converter.getExampleObservation(anyString(), anyString(),
    ...
    //// when(converter.getEnvelope((Collection<SosOffering>)
    // any())).thenReturn(new SosEnvelope());
    //// when(converter.createSosProcedureDescription(any(Procedure.class),
    // anyString(), anyString(),
    //// any(Session.class))).thenCallRealMethod();
    //// when(converter.createSosProcedureDescription(any(Procedure.class),
    // anyString(), anyString(),
    //// anyMapOf(String.class, Procedure.class),
    // any(Session.class))).thenCallRealMethod();
    ////
    //// doNothing().when(converter).checkOutputFormatWithDescriptionFormat(any(Procedure.class),
    // anyString(), anyString());
    //
    ...
    // public void should_throw_exception_with_null_parameters()
    ...
    //
    // @Test
    // public void should_return_sml_system_for_spatial_procedure()
    // throws OwsExceptionReport,
    // ConverterException {
    // final SosProcedureDescription description =
    // converter.createSosProcedureDescription(spatialProcedure, NS_SML,
    // SERVICE_VERSION, SESSION);
    // assertThat(description, is(instanceOf(SensorML.class)));
    // final SensorML smlDesc = (SensorML)
    // description.getProcedureDescription();
    // assertThat(smlDesc.getMembers().get(0), instanceOf(System.class));
    // }
    //
    // @Test
    // public void should_return_sml_process_model_for_smlProcessModel()
    // throws OwsExceptionReport,
    // ConverterException {
    // final SosProcedureDescription description =
    // converter.createSosProcedureDescription(nonSpatialProc, NS_SML,
    // SERVICE_VERSION, SESSION);
    // assertThat(description, is(instanceOf(SensorML.class)));
    // final SensorML smlDesc = (SensorML)
    // description.getProcedureDescription();
    ...
    //
    // @Test
    // public void should_set_description_for_smlProcessModel()
    // throws OwsExceptionReport,
    // ConverterException {
    ...
    // is(PROCEDURE_DESCRIPTION_NON_SPATIAL));
    // }
    //
    // @Test
    // public void should_set_name_for_smlProcessModel()
    // throws OwsExceptionReport,
    // ConverterException {
    // final AbstractProcess process = setupAbstractProcess();
    // assertThat(process.getNames().size(), is(1));
    // assertThat(process.getNames().get(0).getValue(),
    // is(PROCEDURE_IDENTIFIER));
    // }
    //
    // @Test
    // public void should_set_method_for_smlProcessModel()
    // throws OwsExceptionReport,
    // ConverterException {
    ...
    //
    // @Test
    // public void should_set_identifier_for_smlProcessModel()
    // throws OwsExceptionReport,
    // ConverterException {
    // final ProcessModel pModel = setupProcessModel();
    ...
    // ConverterException {
    // final ProcessModel pModel = setupProcessModel();
    // assertThat(pModel.getIdentifications().size(),
    ...
    //
    // @Test
    // public void should_set_outputs_for_smlProcessModel()
    // throws OwsExceptionReport,
    // ConverterException {
    // final ProcessModel pModel = setupProcessModel();
    ...
    // ConverterException {
    // final ProcessModel pModel = setupProcessModel();
    // assertThat(pModel.getMethod().getRulesDefinition(),
    // instanceOf(RulesDefinition.class));
    // assertThat(pModel.getMethod().getRulesDefinition().isSetDescription(),
    // is(Boolean.TRUE));
    // assertThat(pModel.getMethod().getRulesDefinition().getDescription().isEmpty(),
    // is(Boolean.FALSE));
    // assertThat(pModel.getMethod().getRulesDefinition().getDescription(),
    // is(METHOD_DESCRIPTION));
    // }
    //
    // @Test
    // public void should_set_classifiers_for_smlProcessModel()
    // throws OwsExceptionReport,
    // ConverterException {
    // // local fixtures
    // final String intendedApplicationValue =
    // "test-intended-application-value";
    // final String intendedApplicationDefinition =
    // "test-intended-application-definition";
    // final String procedureTypeValue = "test-sensor-type-value";
    // final String procedureTypeDefinition = "test-sensor-type-definition";
    // final ProcedureDescriptionSettings sdgs =
    ...
    // if
    // (classifier.getName().equalsIgnoreCase(SmlClassifier.INTENDED_APPLICATION))
    // {
    // assertThat(classifier.getDefinition(),
    // is(intendedApplicationDefinition));
    // assertThat(classifier.getValue(), is(intendedApplicationValue));
    // } else if
    // (classifier.getName().equalsIgnoreCase(SmlClassifier.PROCEDURE_TYPE)) {
    ...
    // return getIdentifier(pModel, ELEMENT_NAME_SHORT_NAME,
    // "urn:ogc:def:identifier:OGC:1.0:shortname");
    // }
    //
    // private String longNameIdentifierOf(final ProcessModel pModel) {
    // return getIdentifier(pModel, ELEMENT_NAME_LONG_NAME,
    // "urn:ogc:def:identifier:OGC:1.0:longname");
    // }
    //
    // private String uniqueIdIdentifierOf(final ProcessModel pModel) {
    // return getIdentifier(pModel, URN_UNIQUE_IDENTIFIER_END,
    // URN_UNIQUE_IDENTIFIER);
    // }
    //
    // private String getIdentifier(final ProcessModel pModel, final String
    // idName, final String idDefinition) {
    ...
    // }
    //
    // protected ProcessModel setupProcessModel()
    // throws OwsExceptionReport,
    // ConverterException {
    // final AbstractProcess process = setupAbstractProcess();
    ...
    // }
    //
    // protected AbstractProcess setupAbstractProcess()
    // throws OwsExceptionReport,
    // ConverterException {
    // final SensorML description =
    // (SensorML) converter.createSosProcedureDescription(nonSpatialProc,
    // NS_SML, SERVICE_VERSION, SESSION)
