...
public class GetTimeSeriesDescriptionsByUniqueId extends AbstractAquariusGetRequest {
    ...
    public GetTimeSeriesDescriptionsByUniqueId(String uniqueId) {
        addUniqueId(uniqueId);
    }

    public GetTimeSeriesDescriptionsByUniqueId(Collection<String> uniqueIds) {
    ...
    public Map<String, String> getQueryParameters() {
        ...
        if (hasUniqueIds()) {
            parameters.put(AquariusConstants.Parameters.TIME_SERIES_UNIQUE_IDS, String.join(",", getUniqueIds()));
        }
        return parameters;
    }
    ...
    public GetTimeSeriesDescriptionsByUniqueId setUniqueIds(Collection<String> uniqueIds) {
        ...
        if (uniqueIds != null) {
            uniqueIds.forEach(this::addUniqueId);
        }
        return this;
    }

    public boolean hasUniqueIds() {
        return getUniqueIds() != null && !getUniqueIds().isEmpty();
    }
