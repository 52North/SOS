...
public class EnviroCarProcedureCacheUpdate extends AbstractQueueingDatasourceCacheUpdate<EnviroCarProcedureCacheUpdateTask> {

    private static final String THREAD_GROUP_NAME = "envirocar-procedure-cache-update";
