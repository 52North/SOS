...
<div id="url_extension_json" data-value='<c:url value="/admin/extensions/json" />'></div>

<script type="text/javascript" src="<c:url value="/static/js/admin/extensions.js" />"></script>
