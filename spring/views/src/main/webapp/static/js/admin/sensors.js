...
jQuery(document).ready(function ($) {
    ...
    var sensors = JSON.parse($("#sensors").attr("data-value"));
    var procedureFormatMap = JSON.parse($("#procedureFormatMap").attr("data-value"));
    var baseUrl = $("#baseUrl").attr("data-value");
    var describeSensorRequestMethod = $("#describeSensorRequestMethod").attr("data-value");

    var descriptions = new Descriptons({
        describeSensorRequestMethod: describeSensorRequestMethod,
        baseUrl: baseUrl,
        sensors: sensors,
        procedureFormats: procedureFormatMap
    });
    new Controller({
        baseUrl: baseUrl,
