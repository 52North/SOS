...
create table featureOfInterest (featureOfInterestId int8 not null, hibernateDiscriminator char(1) not null, featureOfInterestTypeId int8 not null, identifier varchar(255) unique, codespace int8, name varchar(255), codespaceName int8, description varchar(255), geom GEOMETRY, descriptionXml text, url varchar(255) unique, primary key (featureOfInterestId));
...
create table i18ncapabilities (id int8 not null, codespace int8 not null, title varchar(255), abstract varchar(255), primary key (id), unique (codespace));
create table i18nfeatureOfInterest (id int8 not null, objectId int8 not null, codespace int8 not null, name varchar(255), description varchar(255), primary key (id), unique (objectId, codespace));
create table i18nobservableProperty (id int8 not null, objectId int8 not null, codespace int8 not null, name varchar(255), description varchar(255), primary key (id), unique (objectId, codespace));
create table i18noffering (id int8 not null, objectId int8 not null, codespace int8 not null, name varchar(255), description varchar(255), primary key (id), unique (objectId, codespace));
create table i18nprocedure (id int8 not null, objectId int8 not null, codespace int8 not null, name varchar(255), description varchar(255), primary key (id), unique (objectId, codespace));
...
create table spatialFilteringProfile (spatialFilteringProfileId int8 not null, observation int8 not null, identifier varchar(255) unique, codespace int8, name varchar(255), codespaceName int8, description varchar(255), geom GEOMETRY not null, primary key (spatialFilteringProfileId));
...
alter table i18ncapabilities add constraint i18ncapsCodespaceFk foreign key (codespace) references codespace;
...
alter table i18nfeatureOfInterest add constraint i18nfeatureCodespaceFk foreign key (codespace) references codespace;
...
alter table i18nobservableProperty add constraint i18nObsPropCodespaceFk foreign key (codespace) references codespace;
...
alter table i18noffering add constraint i18nOfferingCodespaceFk foreign key (codespace) references codespace;
...
alter table i18nprocedure add constraint i18nProcedureCodespaceFk foreign key (codespace) references codespace;
...
alter table spatialFilteringProfile add constraint sfpCodespaceIdentifierFk foreign key (codespace) references codespace;
alter table spatialFilteringProfile add constraint sfpCodespaceNameFk foreign key (codespaceName) references codespace;
