...
<form action="<c:url value="/install/datasource" />" method="POST" class="form-horizontal">
    ...
    <fieldset id="actions" style="display: none;">
        <legend>Actions</legend>
       		 ...
       		 <p>If each of your observation relates to only one offering, you can use the update script provided in the SOS sources folder <strong>/misc/db/.../..update__441_442.sql</strong>.</p>
