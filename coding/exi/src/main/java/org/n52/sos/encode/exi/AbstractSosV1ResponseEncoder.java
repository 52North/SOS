...
/**
 * Abstract response encoder class for {@link EXIObject} and SOS 1.0.0
 * operations
 * 
...
public abstract class AbstractSosV1ResponseEncoder<T extends AbstractServiceResponse> extends
     ...
     */
    public AbstractSosV1ResponseEncoder(Class<T> type, String operation) {
        super(type, operation, Sos1Constants.SERVICEVERSION);
    }
     ...
     */
    public AbstractSosV1ResponseEncoder(Class<T> type, Enum<?> operation) {
