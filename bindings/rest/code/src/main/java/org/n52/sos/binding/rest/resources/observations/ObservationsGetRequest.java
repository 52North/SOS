...
public class ObservationsGetRequest implements IObservationsRequest {
    ...
    public ObservationsGetRequest(GetObservationByIdRequest getObservationByIdRequest, GetCapabilitiesRequest getCapabilitesRequestOnlyContents) {
        this.getObservationByIdRequest = getObservationByIdRequest;
        this.getCapabilitesRequestOnlyContents = getCapabilitesRequestOnlyContents;
    }
