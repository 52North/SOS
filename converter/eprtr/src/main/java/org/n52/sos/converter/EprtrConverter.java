...
public class EprtrConverter implements RequestResponseModifier {
    ...
    static final String METHOD_BASIS_CODE = "MethodBasisCode";
    static final String ACCIDENTIAL_QUANTITY = "AccidentialQuantity";
    static final String MEDIUM_CODE = "MediumCode";
    ...
    private boolean containsConfidentialCode;
    ...
    private void checkFeature(AbstractFeature abstractFeature) {
        if (abstractFeature instanceof AbstractSamplingFeature) {
            ...
            if (asf.isSetParameter() && isPrtr(asf.getParameters())
                ...
                containsConfidentialCode = assessConfidential.containsConfidentialCode(asf.getParameters());
                if (containsConfidentialCode) {
