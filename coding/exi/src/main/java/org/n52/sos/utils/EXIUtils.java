...
public class EXIUtils {
	...
	public EXIFactory newEXIFactory() throws UnsupportedOption{
		...
		//	GRAMMAR
		//
		// TODO How to identify the correct location: SOS 1.0 vs. 2.0 vs WFS vs WPS ...
		Grammars g = null;
		...
		//
		// TODO is it possible to identify these options via any EXI header or something else?
		if (isStrict) {
