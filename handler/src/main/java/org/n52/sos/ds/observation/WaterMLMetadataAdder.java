...
public class WaterMLMetadataAdder extends SeriesMetadataAdder {
    ...
    public WaterMLMetadataAdder(OmObservation omObservation, DatasetEntity dataset) {
    ...
    public WaterMLMetadataAdder add() throws CodedException {
        if (getDataset().hasParameters()) {
             ...
             */
            Optional<Object> interpolationTypeTitle = getMetadataElement(WaterMLConstants.INTERPOLATION_TYPE);
            /*
             * Default Value
             */
            ...
            // aggregationDuration
            Optional<Object> aggregationDuration = getMetadataElement(WaterMLConstants.EN_AGGREGATION_DURATION);
            ...
            Optional<Object> cumulativeMetadata = getMetadataElement(WaterMLConstants.SERIES_METADATA_CUMULATIVE);
            /*
             * Default Value
             */
    ...
    protected Optional<Object> getMetadataElement(String name) {
        return getMetadataElement(getDataset(), WaterMLConstants.NS_WML_20, name);
    }
