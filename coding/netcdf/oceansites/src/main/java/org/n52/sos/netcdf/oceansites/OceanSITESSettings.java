...
public class OceanSITESSettings implements SettingDefinitionProvider {
    ...
    private static final Set<SettingDefinition<?, ?>> DEFINITIONS = ImmutableSet.<SettingDefinition<?, ?>> of(
            ...
            setDescription("A statement describing the data distribution policy; "
            ...
            setDescription("The citation to be used in publications using the dataset; "
                    + "should include a reference to OceanSITES but may contain any other "
                    + "text deemed appropriate by the PI and DAC.").
            setOptional(true).
            setOrder(ORDER_1),
            ...
            setDefaultValue(OceanSITESConstants.CITATION_DEFAULT_TEXT).
            setDescription("A place to acknowledge various types of support for the project that produced this data.").
            setOptional(true).
            setOrder(ORDER_2),
            
            new StringSettingDefinition().
            setGroup(SETTINGS_GROUP).
            setKey(OCEANSITES_PROJECT).
