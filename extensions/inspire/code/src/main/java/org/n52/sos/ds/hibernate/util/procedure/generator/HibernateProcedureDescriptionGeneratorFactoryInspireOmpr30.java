 ...
 *
 */
public class HibernateProcedureDescriptionGeneratorFactoryInspireOmpr30 implements
    ...
    public SosProcedureDescription create(Procedure procedure, Locale i18n, Session session) throws OwsExceptionReport {
        return new HibernateProcedureDescriptionGeneratorInspireOmpr30()
...
//            process.setType();
        ...
        private void addResponsibleParty() {
