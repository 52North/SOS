...
/**
 * Observation entity class extends AbstractObservation to allow full
 * observations.
 * 
 * @since 4.0.0
 * 
 */
public class Observation extends AbstractObservation implements Serializable, HasObservableProperty,
