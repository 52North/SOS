...
drop table booleanParameterValue cascade constraints;
drop table booleanValue cascade constraints;
drop table categoryParameterValue cascade constraints;
...
drop table countParameterValue cascade constraints;
...
drop table numericParameterValue cascade constraints;
...
drop table textParameterValue cascade constraints;
