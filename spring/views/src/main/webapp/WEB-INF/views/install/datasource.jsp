...
<form action="<c:url value="/install/datasource" />" method="POST" class="form-horizontal">
    ...
    <fieldset id="actions" style="display: none;">
        <legend>Actions</legend>
       		 ...
       		 <p>This requires an update of existing database model which can be performed with <strong><em>Force updating existing tables</em></strong>, but the new table is not filled with values.</p>
       		 <p>Please, update the table with the appropriate update script provided in the SOS sources folder <strong>/misc/db/.../.._437_to_438.sql</strong>.</p>
