 ...
 */
public abstract class AbstractSosV2ResponseEncoder<T extends AbstractServiceResponse> extends
     ...
     */
    public AbstractSosV2ResponseEncoder(Class<T> type, String operation) {
        super(type, operation, Sos2Constants.SERVICEVERSION);
    }
     ...
     */
    public AbstractSosV2ResponseEncoder(Class<T> type, Enum<?> operation) {
