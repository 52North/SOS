...
class WonderwareObservableObjectCursor extends WonderwareObservableDataCursor<ObservableObject>
{
     ...
     */
    public WonderwareObservableObjectCursor(ObservableModel observableModel, String objectId, String databaseDriverClass, String databaseConnectionUrl, SimpleFeatureSource featureSource, String featureKey, ReferencedEnvelope envelope, List<SimpleObservableAttribute> attributeList)
    {
