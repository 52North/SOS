...
/**
 * Defines a generic solver interface of EPANET networks.
 * 
 * @author Alvaro Huarte <ahuarte@tracasa.es>
 */
public interface EpanetSolver
{
    /**
     * Load the configuration data from the specified settings entry.
     */
    public void loadSettings(String settingsFileName, org.w3c.dom.Element rootEntry, org.w3c.dom.Element moldelEntry, org.w3c.dom.Element solverEntry);
