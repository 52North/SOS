...
//
//        PROCEDURE_DESCRIPTION_NON_SPATIAL = format("The %s with the id %s observes the following properties: %s.",
//                "procedure", PROCEDURE_IDENTIFIER, Joiner.on(",").join(OBSERVABLE_PROPERTIES));
//
...
//
//
//        HibernateProcedureDescriptionGeneratorSml101 hibernateProcedureDescriptionGeneratorSml101 =
//                new HibernateProcedureDescriptionGeneratorFactorySml101(daoFactory, settingsService, geometryHandler, i18NDAORepository, cacheController, profileHandler);
//        FACTORY_REPOSITORY =
...
////                decoderRepository, FACTORY_REPOSITORY, i18nr, daoFactory, converterRepository, geometryHandler,
////                bindingRepository, serviceOperatorRepository, contentCacheController, procedureSettings);
